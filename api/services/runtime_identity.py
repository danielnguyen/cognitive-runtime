...
from services.runtime_state import resolve_runtime_session
...
def _persona_record(*, requested_persona_id: str | None, surface: str):
    repository = companion_contracts_repository()
    ...
    binding = _surface_binding(surface)
